    ...
    <div className='flex flex-row'>
        <div className='flex flex-col py-4'>
            <div className='md:px-2 lg:px-3 px-3 '>
                <img src='/img/Readersimg.png' className='w-24 md:w-28 lg:w-52' alt=''/>
                </div>
                <div className='flex flex-col justify-start items-center gap-x-2 px-4  py-2'>
                <img src='/img/Star.svg' className='w-20 md:w-28 lg:w-40' alt=''/>
        ...
        <div className='flex flex-col justify-start items-start px-1 md:px-2 lg:px-2  gap-y-2 '>
...
<h2 className="text-[color:var(--Black-text-color,#3A3A3A)] text-[16px] font-Lexend not-italic font-medium leading-[normal]">Exp :</h2>
                ...
                <div>
                    <h2 className="text-[color:var(--grey-1,#A1A1A1)] text-[10px] font-Lexend text-start not-italic font-medium leading-[normal]">Job, Career, Finance, Marriage, Love, Relationships, Education, Health</h2>
                </div>
                <div className='flex flex-row gap-x-2 py-1 md:py-1'>
 ...
 <div className='flex flex-row justify-start items-center gap-x-1.5 md:gap-x-0 pb-3'>
    <div className='px-5 md:px-20 gap-x-2 py-2 bg-[#FFA300] rounded-[45px] flex flex-row justify-center items-center '>
